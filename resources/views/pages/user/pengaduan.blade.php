        ...
        <section class="inner-page">
            <div class="container">
                <div class="title text-center mb-5">
                    <h3 class="fw-bold"><strong>Layanan Pengaduan Masyarakat</strong></h3>
                    <h5 class="fw-bold text-danger">Sampaikan dan laporkan pengaduan anda</h5>
                </div>
                <div class="card card-responsive p-4 border-0 col-md-8 shadow rounded mx-auto bg-secondary">
                    <form action="{{ route('pengaduan.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-3">
                            <label for="judul_laporan" class="form-label text-light">Judul Laporan</label>
                        ...
                        <div class="form-group mb-3">
                            <label for="isi_laporan" class="form-label text-light">Isi Laporan</label>
                        ...
                        <div class="form-group mb-3">
                            <label for="tgl_kejadian" class="form-label text-light">Tanggal Kejadian</label>
                        ...
                        <div class="form-group mb-3">
                            <label for="lokasi_kejadian" class="form-label text-light">Lokasi Kejadian</label>
                        ...
                        <div class="form-group mb-3">
                            <label for="foto" class="form-label text-light">Foto Bukti Pengaduan</label>
