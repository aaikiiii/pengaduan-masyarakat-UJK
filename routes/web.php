...
Route::middleware(['isMasyarakat'])->group(function () {
     ...
     Route::get('/ubah',  [\App\Http\Controllers\User\UserController::class, 'edit']);
     Route::patch('/ubah',  [\App\Http\Controllers\User\UserController::class, 'update']);
     ...
     Route::get('/pengaduan/delete/{id_pengaduan}', [\App\Http\Controllers\User\UserController::class, 'laporanDestroy'])->name('pengaduan.delete');
});
