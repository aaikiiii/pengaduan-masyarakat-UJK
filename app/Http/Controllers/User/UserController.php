...
class UserController extends Controller
{
    ...
    public function laporanDestroy(Request $request)
    {
        ...
        return redirect()->route('pengaduan.laporan');
    }
...

    {
        ...
        $provinces = Province::all();
        $regencies = Regency::where('province_id', $masyarakat->province_id)->get();

        $districts = District::where('regency_id', $masyarakat->regency_id)->get();

        $villages = Village::where('district_id', $masyarakat->district_id)->get();
        $title = 'Ubah Profil';

        return view('pages.user.edit', compact('masyarakat','provinces','pengaduan','regencies','districts','villages'));
    ...
    public function profil()
    {
        ...
        return view('pages.user.profil', ['masyarakat' => $masyarakat]);
    }
...

    {
        ...
        return redirect('/profil')->with('success', 'Ubah data berhasil!');
